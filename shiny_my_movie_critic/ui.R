  ...
  navbarPage("My Movie Critic", id = 'inTabset', theme = shinytheme('cerulean'),
             ...
             tabPanel(title = 'Your Critic', value = 'your_critic',
                      fluidRow(
                        ...
                        column(h3('Critic Rating High / Average Rating Low'),
                               DT::dataTableOutput('critic_high'), width = 6, title = 'Unpopular Movies to Check Out'),
                        column(h3('Critic Rating Low / Average Rating High'),
                               DT::dataTableOutput('critic_low'), width = 6, title = 'Popular Movies to Avoid')
                      )
             ),
             # About me tab
